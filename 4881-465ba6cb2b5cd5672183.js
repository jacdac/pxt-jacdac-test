"use strict";
(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[4881],{
...
function useDescendant(descendant) {
  ...
  (0,useEnhancedEffect/* default */.Z)(() => {
    if (descendant.element) {
      registerDescendant((0,esm_extends/* default */.Z)({}, descendant, {
        index
      }));
      return () => {
...
function DescendantProvider(props) {
  ...
  const registerDescendant = react.useCallback(_ref => {
    let {
      ...
      other = (0,objectWithoutPropertiesLoose/* default */.Z)(_ref, _excluded);
    set(oldItems => {
      let newItems;
      if (oldItems.length === 0) {
        // If there are no items, register at index 0 and bail.
        return [(0,esm_extends/* default */.Z)({}, other, {
          element,
          index: 0
        })];
      }
      ...
      if (oldItems[index] && oldItems[index].element === element) {
        ...
        const newItem = (0,esm_extends/* default */.Z)({}, other, {
          element,
          index
        });
...
const TreeView_excluded = ["children", "className", "defaultCollapseIcon", "defaultEndIcon", "defaultExpanded", "defaultExpandIcon", "defaultParentIcon", "defaultSelected", "disabledItemsFocusable", "disableSelection", "expanded", "id", "multiSelect", "onBlur", "onFocus", "onKeyDown", "onNodeFocus", "onNodeSelect", "onNodeToggle", "selected"];
...
const TreeView = /*#__PURE__*/react.forwardRef(function TreeView(inProps, ref) {
  ...
  const {
    ...
    other = (0,objectWithoutPropertiesLoose/* default */.Z)(props, TreeView_excluded);
...
var ArrowDropDown = __webpack_require__(45111);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/ArrowRight.js
var ArrowRight = __webpack_require__(21596);
...
function useTreeItem(nodeId) {
  const {
    ...
    selectRange,
    toggleExpansion
  } = react.useContext(TreeView_TreeViewContext);
...
const TreeItemContent_excluded = ["classes", "className", "displayIcon", "expansionIcon", "icon", "label", "nodeId", "onClick", "onMouseDown"];
...
const TreeItemContent = /*#__PURE__*/react.forwardRef(function TreeItemContent(props, ref) {
  const {
    ...
    other = (0,objectWithoutPropertiesLoose/* default */.Z)(props, TreeItemContent_excluded);
  const {
    disabled,
    expanded,
    selected,
...
const TreeItem_useUtilityClasses = ownerState => {
  const {
    classes
  } = ownerState;
  const slots = {
...
const TreeItem = /*#__PURE__*/react.forwardRef(function TreeItem(inProps, ref) {
  ...
  const classes = TreeItem_useUtilityClasses(ownerState);
  let displayIcon;
  let expansionIcon;
  if (expandable) {
    if (!expanded) {
...
function DeviceProductInformationTreeItem(props){var{device}=props;var{id}=device;var specification=(0,useDeviceSpecification/* default */.ZP)(device);if(!specification)return null;var to="/devices/"+(0,catalog/* identifierToUrlPath */.uM)(specification.id);return/*#__PURE__*/react.createElement(StyledTreeItem,{nodeId:id+":catalog",labelTo:to,labelText:specification.name,labelInfo:specification.company});}
// EXTERNAL MODULE: ./src/components/devices/DeviceActions.tsx
var DeviceActions = __webpack_require__(42714);
;// CONCATENATED MODULE: ./src/components/devices/AnnounceFlagsTreeItem.tsx
function AnnounceFlagsTreeItem(props){var{device,showIdentify}=props;var{announceFlags,id,deviceId,restartCounter,proxy}=device;var text=[deviceId,proxy&&"proxy",announceFlags&specconstants/* ControlAnnounceFlags.IsClient */.P99.IsClient&&"client",announceFlags&specconstants/* ControlAnnounceFlags.SupportsACK */.P99.SupportsACK&&"acks",announceFlags&specconstants/* ControlAnnounceFlags.SupportsBroadcast */.P99.SupportsBroadcast&&"broadcast",announceFlags&specconstants/* ControlAnnounceFlags.SupportsFrames */.P99.SupportsFrames&&"frames",(announceFlags&specconstants/* ControlAnnounceFlags.StatusLightRgbFade */.P99.StatusLightRgbFade)===specconstants/* ControlAnnounceFlags.StatusLightMono */.P99.StatusLightMono&&"mono status LED",(announceFlags&specconstants/* ControlAnnounceFlags.StatusLightRgbFade */.P99.StatusLightRgbFade)===specconstants/* ControlAnnounceFlags.StatusLightRgbNoFade */.P99.StatusLightRgbNoFade&&"rgb no fade status LED",(announceFlags&specconstants/* ControlAnnounceFlags.StatusLightRgbFade */.P99.StatusLightRgbFade)===specconstants/* ControlAnnounceFlags.StatusLightRgbFade */.P99.StatusLightRgbFade&&"rgb fade status LED",restartCounter<0xf?"restart#"+restartCounter:undefined].filter(f=>!!f).join(", ");return/*#__PURE__*/react.createElement(StyledTreeItem,{nodeId:id+":flags",labelText:text,actions:/*#__PURE__*/react.createElement(DeviceActions/* default */.Z,{device:device,showReset:true,showProxy:true,hideIdentity:!showIdentify})});}
// EXTERNAL MODULE: ./src/jacdac/useDeviceDescription.ts
var useDeviceDescription = __webpack_require__(69461);
;// CONCATENATED MODULE: ./src/components/tools/JDomTreeViewItems.tsx
var JDomTreeViewItems_excluded=["device","serviceFilter"],_excluded2=["service","registerFilter","eventFilter"];// tslint:disable-next-line: no-submodule-imports match-default-export-name
function DeviceTreeItem(props){var{device,serviceFilter}=props,other=(0,objectWithoutPropertiesLoose/* default */.Z)(props,JDomTreeViewItems_excluded);var{id,isPhysical}=(0,react.useMemo)(()=>device,[device]);var name=(0,useDeviceName/* default */.Z)(device,true);var description=(0,useDeviceDescription/* default */.Z)(device);var kind=isPhysical?"device":"virtualdevice";var lost=(0,useEventRaised/* default */.Z)([constants/* LOST */.XWw,constants/* FOUND */.a6y],device,dev=>!!(dev!==null&&dev!==void 0&&dev.lost));var services=(0,useEventRaised/* default */.Z)(constants/* ANNOUNCE */.oNX,device,_=>_.services({mixins:false}).filter(srv=>!serviceFilter||serviceFilter(srv)));var stats=(0,useChange/* default */.Z)(device,_=>_.stats);var dropped=(0,useChange/* default */.Z)(stats,_=>_.dropped);var restarts=(0,useChange/* default */.Z)(stats,_=>_.restarts);var serviceNames=(0,utils/* ellipseJoin */.VA)(services.filter(srv=>!(0,spec/* isInfrastructure */.lz)(srv.specification)).map(service=>service.name),26);var alert=lost?"lost device":restarts>1?restarts+" restarts":dropped>2?(0,utils/* roundWithPrecision */.JI)(dropped,1)+" pkt lost":undefined;var warning=restarts>1||dropped>2;var labelInfo=serviceNames;return/*#__PURE__*/react.createElement(StyledTreeItem,{nodeId:id,labelText:name,labelCaption:description,labelInfo:labelInfo,warning:warning,alert:alert,kind:kind,icon:/*#__PURE__*/react.createElement(DeviceAvatar/* default */.Z,{device:device,size:"small",center:false})},/*#__PURE__*/react.createElement(DeviceProductInformationTreeItem,{device:device}),/*#__PURE__*/react.createElement(AnnounceFlagsTreeItem,{device:device}),services===null||services===void 0?void 0:services.map(service=>/*#__PURE__*/react.createElement(ServiceTreeItem,Object.assign({key:service.nodeId,service:service,showSpecification:true},other))));}function ServiceMembersTreeItems(props){var{service,registerFilter,eventFilter}=props,other=(0,objectWithoutPropertiesLoose/* default */.Z)(props,_excluded2);var{specification,mixins}=(0,react.useMemo)(()=>service,[service]);var packets=specification===null||specification===void 0?void 0:specification.packets;var registers=packets===null||packets===void 0?void 0:packets.filter(pkt=>!pkt.client&&(0,spec/* isRegister */.x5)(pkt)).map(info=>service.register(info.identifier)).filter(reg=>!reg.notImplemented).filter(reg=>!registerFilter||registerFilter(reg)).sort((l,r)=>l.name.localeCompare(r.name));var events=packets===null||packets===void 0?void 0:packets.filter(pkt=>!pkt.client&&(0,spec/* isEvent */.cO)(pkt)).map(info=>service.event(info.identifier)).filter(ev=>!eventFilter||eventFilter(ev));return/*#__PURE__*/react.createElement(react.Fragment,null,registers===null||registers===void 0?void 0:registers.map(register=>/*#__PURE__*/react.createElement(RegisterTreeItem,Object.assign({key:register.id,register:register},other))),events===null||events===void 0?void 0:events.map(event=>/*#__PURE__*/react.createElement(EventTreeItem,Object.assign({key:event.id,event:event},other))),mixins===null||mixins===void 0?void 0:mixins.map(mixin=>/*#__PURE__*/react.createElement(ServiceTreeItem,Object.assign({key:mixin.id,service:mixin},other))));}function ServiceSpecificationTreeItem(props){var{service}=props;var{id,specification}=service;if(!specification)return null;var{classIdentifier}=specification;var nodeId=id+":spec";var labelText=((specification===null||specification===void 0?void 0:specification.notes["short"])||specification.name).split(".",1)[0]+".";var labelTo="/services/"+specification.shortId+"/";return/*#__PURE__*/react.createElement(StyledTreeItem,{nodeId:nodeId,labelText:labelText,labelInfo:"id: 0x"+classIdentifier.toString(16),labelTo:labelTo});}function ServiceTreeItem(props){var{service,showSpecification,showMembersOnly}=props;var{isMixin,name,id}=(0,react.useMemo)(()=>service,[service]);var instanceName=(0,useInstanceName/* default */.Z)(service);var readingRegister=useBestRegister(service);var reading=(0,useRegisterValue/* useRegisterHumanValue */.e_)(readingRegister,{visible:true,maxLength:18});var labelText=name+(instanceName?" "+instanceName:"");var members=/*#__PURE__*/react.createElement(react.Fragment,null,showSpecification&&/*#__PURE__*/react.createElement(ServiceSpecificationTreeItem,{service:service}),/*#__PURE__*/react.createElement(ServiceMembersTreeItems,Object.assign({service:service},props)));if(showMembersOnly)return members;return/*#__PURE__*/react.createElement(StyledTreeItem,{nodeId:id,labelText:labelText,labelInfo:reading,kind:isMixin?constants/* SERVICE_MIXIN_NODE_NAME */.mLn:constants/* SERVICE_NODE_NAME */.M_U},members);}function RegisterTreeItem(props){var{register}=props;var{specification,id,notImplemented}=register;var optional=!!(specification!==null&&specification!==void 0&&specification.optional);var labelText=(0,jdspec/* humanify */.lW)(""+((specification===null||specification===void 0?void 0:specification.name)||id)+(optional?"?":""));var humanValue=(0,useRegisterValue/* useRegisterHumanValue */.e_)(register,{visible:true});var handleClick=(0,react.useCallback)(()=>register.sendGetAsync(),[register]);var attempts=(0,useEventRaised/* default */.Z)(constants/* GET_ATTEMPT */.tDM,register,_=>_===null||_===void 0?void 0:_.lastGetAttempts);var failedGet=attempts>2;// not implemented
if(notImplemented)return null;// if register is optional and no data, hide
if(optional&&failedGet&&humanValue===undefined)return null;return/*#__PURE__*/react.createElement(StyledTreeItem,{nodeId:id,labelText:labelText,labelInfo:humanValue||attempts>0&&"#"+attempts||"",kind:(specification===null||specification===void 0?void 0:specification.kind)||constants/* REGISTER_NODE_NAME */.nJc,alert:failedGet&&!optional&&humanValue===undefined&&"???",onClick:handleClick});}function EventTreeItem(props){var{event}=props;var{specification,id}=event;var count=(0,useEventCount/* default */.Z)(event);var labelText=(0,jdspec/* humanify */.lW)((specification===null||specification===void 0?void 0:specification.name)||event.id);return/*#__PURE__*/react.createElement(StyledTreeItem,{nodeId:id,labelText:labelText,labelInfo:(count||"")+"",kind:constants/* EVENT_NODE_NAME */.Yuh});}
// EXTERNAL MODULE: ./jacdac-ts/src/jdom/flags.ts
var flags = __webpack_require__(86160);
;// CONCATENATED MODULE: ./src/components/tools/JDomTreeView.tsx
var JDomTreeView_excluded=["defaultExpanded","defaultSelected"];// tslint:disable-next-line: no-submodule-imports
// tslint:disable-next-line: no-submodule-imports match-default-export-name
// tslint:disable-next-line: no-submodule-imports match-default-export-name
// tslint:disable-next-line: no-submodule-imports match-default-export-name
// tslint:disable-next-line: no-submodule-imports match-default-export-name
var JDomTreeView_PREFIX="JDomTreeView";var JDomTreeView_classes={root:JDomTreeView_PREFIX+"root",margins:JDomTreeView_PREFIX+"margins"};var StyledTreeView=(0,styled/* default */.ZP)(TreeView_TreeView)(_ref=>{var{theme}=_ref;return{["&."+JDomTreeView_classes.root]:{flexGrow:1},["&."+JDomTreeView_classes.margins]:{marginLeft:theme.spacing(0.5),marginRight:theme.spacing(0.5)}};});function JDomTreeView(props){var{defaultExpanded,defaultSelected}=props,other=(0,objectWithoutPropertiesLoose/* default */.Z)(props,JDomTreeView_excluded);var{0:expanded,1:setExpanded}=(0,react.useState)(defaultExpanded||[]);var{0:selected,1:setSelected}=(0,react.useState)(defaultSelected||[]);var devices=(0,useDevices/* default */.Z)({ignoreInfrastructure:!flags/* Flags.diagnostics */.v.diagnostics});var handleToggle=(event,nodeIds)=>{setExpanded(nodeIds);};var handleSelect=(event,nodeIds)=>{setSelected(nodeIds);};return/*#__PURE__*/react.createElement(StyledTreeView,{className:(0,clsx_m/* default */.Z)(JDomTreeView_classes.root,JDomTreeView_classes.margins),defaultCollapseIcon:/*#__PURE__*/react.createElement(ArrowDropDown/* default */.Z,null),defaultExpandIcon:/*#__PURE__*/react.createElement(ArrowRight/* default */.Z,null),defaultEndIcon:/*#__PURE__*/react.createElement("div",{style:{width:12}}),expanded:expanded,selected:selected,onNodeToggle:handleToggle,onNodeSelect:handleSelect},devices===null||devices===void 0?void 0:devices.map(device=>/*#__PURE__*/react.createElement(DeviceTreeItem,Object.assign({key:device.id,device:device,expanded:expanded,selected:selected},other))));}
...
//# sourceMappingURL=4881-465ba6cb2b5cd5672183.js.map