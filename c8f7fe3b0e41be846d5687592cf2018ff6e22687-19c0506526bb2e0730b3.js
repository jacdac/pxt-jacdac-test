(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[317,1269,1193],{
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "Z": function() { return /* binding */ PacketListItem; }
});
...
var Error = __webpack_require__(89572);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/Message.js
var Message = __webpack_require__(76824);
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/Note.js
var Note = __webpack_require__(79823);
;// CONCATENATED MODULE: ./src/components/LogMessageIcon.tsx
var _excluded=["identifier"];// tslint:disable-next-line: no-submodule-imports match-default-export-name
// tslint:disable-next-line: no-submodule-imports match-default-export-name
// tslint:disable-next-line: no-submodule-imports match-default-export-name
// tslint:disable-next-line: no-submodule-imports match-default-export-name
function LogMessageIcon(props){var{identifier}=props,others=(0,objectWithoutPropertiesLoose/* default */.Z)(props,_excluded);switch(identifier){case constants/* LoggerCmd.Warn */.eQc.Warn:return/*#__PURE__*/react.createElement(Warning/* default */.Z,others);case constants/* LoggerCmd.Error */.eQc.Error:return/*#__PURE__*/react.createElement(Error/* default */.Z,others);case constants/* LoggerCmd.Debug */.eQc.Debug:return/*#__PURE__*/react.createElement(Note/* default */.Z,others);default:return/*#__PURE__*/react.createElement(Message/* default */.Z,others);}}
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/ArrowLeft.js
var ArrowLeft = __webpack_require__(93412);
...
var Code = __webpack_require__(96214);
...
function PacketBadge(props){var{packet,count}=props;var{decoded}=packet;var{error}=decoded||{};var requiredAck=!!packet.requiresAck;var failedAck=!!packet.meta[constants/* META_ACK_FAILED */.GiR];var receivedAck=!failedAck&&!!packet.meta[constants/* META_ACK */.K3O];var getPacket=!!packet.meta[constants/* META_GET */.cWR];var notImplemented=!!packet.meta[constants/* META_NOT_IMPLEMENTED */.EZK];var direction=packet.isCommand?"to":"from";var logMessage=packet.serviceClass===specconstants/* SRV_LOGGER */.w9j&&packet.isReport&&!packet.isRegisterGet;return/*#__PURE__*/react.createElement(Badge/* default */.Z,{badgeContent:count},error&&/*#__PURE__*/react.createElement(Tooltip/* default */.Z,{title:error},/*#__PURE__*/react.createElement("span",null,/*#__PURE__*/react.createElement(Error/* default */.Z,{color:"error"}))),notImplemented&&/*#__PURE__*/react.createElement(Tooltip/* default */.Z,{title:"not implemented"},/*#__PURE__*/react.createElement("span",null,/*#__PURE__*/react.createElement(Warning/* default */.Z,{color:"warning"}))),getPacket&&!failedAck&&!receivedAck&&/*#__PURE__*/react.createElement(Tooltip/* default */.Z,{title:"to/from "+packet.friendlyDeviceName},/*#__PURE__*/react.createElement("span",null,/*#__PURE__*/react.createElement(Code/* default */.Z,null))),direction==="to"&&!getPacket&&!failedAck&&!receivedAck&&/*#__PURE__*/react.createElement(Tooltip/* default */.Z,{title:"to "+packet.friendlyDeviceName},/*#__PURE__*/react.createElement("span",null,/*#__PURE__*/react.createElement(ArrowLeft/* default */.Z,null))),direction==="from"&&!getPacket&&!failedAck&&!receivedAck&&/*#__PURE__*/react.createElement(Tooltip/* default */.Z,{title:"from "+packet.friendlyDeviceName},/*#__PURE__*/react.createElement("span",null,/*#__PURE__*/react.createElement(ArrowRight/* default */.Z,null))),requiredAck===true&&failedAck&&/*#__PURE__*/react.createElement(Tooltip/* default */.Z,{title:"no ack"},/*#__PURE__*/react.createElement("span",null,/*#__PURE__*/react.createElement(Clear/* default */.Z,null))),requiredAck===true&&receivedAck&&/*#__PURE__*/react.createElement(Tooltip/* default */.Z,{title:"ack received"},/*#__PURE__*/react.createElement("span",null,/*#__PURE__*/react.createElement(KindIcon/* default */.ZP,{kind:constants/* CRC_ACK_NODE_NAME */.REx}))),logMessage?/*#__PURE__*/react.createElement(LogMessageIcon,{identifier:decoded===null||decoded===void 0?void 0:decoded.info.identifier}):/*#__PURE__*/react.createElement(KindIcon/* default */.ZP,{kind:packet.isCRCAck?"crc_ack":packet.isPipe?"pipe":packet.isAnnounce?"announce":decoded===null||decoded===void 0?void 0:decoded.info.kind}));}
...
var useMediaQueries = __webpack_require__(11462);
;// CONCATENATED MODULE: ./src/components/PacketListItem.tsx
var PREFIX="PacketListItem";var classes={item:PREFIX+"item"};var StyledListItem=(0,styled/* default */.ZP)(ListItem/* default */.ZP)(()=>({["&."+classes.item]:{marginBottom:0,borderBottom:"1px solid #ddd"}}));function PacketListItem(props){var{packet,count,showTime,showRaw}=props;var{selectedPacket,setSelectedPacket}=(0,react.useContext)(AppContext/* default */.ZP);var{setDrawerType}=(0,react.useContext)(AppContext/* default */.ZP);var{mobile}=(0,useMediaQueries/* default */.Z)();var{decoded}=packet;var{info}=decoded||{};var handleClick=()=>{if(mobile)setDrawerType(AppContext/* DrawerType.None */.jw.None);setSelectedPacket(packet);(0,gatsby_browser_entry.navigate)("/tools/packet-inspector/");};var selected=packet===selectedPacket;var logMessage=packet.serviceClass===constants/* SRV_LOGGER */.w9j&&packet.isReport;var pipePackets=packet.meta[constants/* META_PIPE */.YHR];var notImplemented=!!packet.meta[constants/* META_NOT_IMPLEMENTED */.EZK];var name=(info===null||info===void 0?void 0:info.name)||packet.friendlyCommandName;var primary=packet.isCRCAck&&"crc ack "+name||packet.isAnnounce&&"announce from "+name||packet.isRegisterGet&&"get "+name||pipePackets&&"pipe port:"+packet.pipePort+" "+pipePackets.length+" packets"||logMessage&&(0,pack/* jdunpack */.TE)(packet.data,"s")[0]||""+(packet.isRegisterSet?"set ":"")+name+" "+(decoded?(0,utils/* ellipseJoin */.VA)(decoded.decoded.map(f=>f.humanValue),18):"");var secondary=""+(showTime?(0,pretty/* prettyDuration */.Xh)(packet.timestamp,true)+": ":"")+(packet.isCommand?"to":"from")+" "+packet.friendlyDeviceName+"/"+packet.friendlyServiceName+(notImplemented?", not implemented":"");return/*#__PURE__*/react.createElement(StyledListItem,{className:classes.item,dense:true,onClick:handleClick,selected:selected},/*#__PURE__*/react.createElement(ListItemIcon/* default */.Z,null,/*#__PURE__*/react.createElement(PacketBadge,{packet:packet,count:count})),/*#__PURE__*/react.createElement(ListItemText/* default */.Z,{primary:/*#__PURE__*/react.createElement(Box/* default */.Z,{textOverflow:"ellipsis"},primary),secondary:/*#__PURE__*/react.createElement(react.Fragment,null,secondary,showRaw&&", "+(0,utils/* toHex */.NC)(packet.toBuffer()))}));}
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(97920);
...
//# sourceMappingURL=c8f7fe3b0e41be846d5687592cf2018ff6e22687-19c0506526bb2e0730b3.js.map