"use strict";
(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[8323,6267,2975,6749,9161,6895],{
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(97920);
...
// EXTERNAL MODULE: ./node_modules/@mui/icons-material/Fingerprint.js
var Fingerprint = __webpack_require__(80610);
...
;// CONCATENATED MODULE: ./src/components/IDChip.tsx
// tslint:disable-next-line: no-submodule-imports match-default-export-name
function IDChip(props){var{id,className,filter}=props;var{filter:packetFilter,setFilter:setPacketFilter}=(0,react.useContext)(PacketsContext/* default */.Z);var{setDrawerType}=(0,react.useContext)(AppContext/* default */.ZP);var ids=typeof id==="string"?id:"0x"+(id!==undefined?id.toString(16):"???");var filtered=packetFilter&&packetFilter.indexOf(filter)>-1;var handleFilterClick=()=>{var _packetFilter$replace;if(filtered)setPacketFilter(packetFilter===null||packetFilter===void 0?void 0:(_packetFilter$replace=packetFilter.replace(filter,""))===null||_packetFilter$replace===void 0?void 0:_packetFilter$replace.trim());else setPacketFilter((packetFilter===null||packetFilter===void 0?void 0:packetFilter.trim())+" "+filter);setDrawerType(AppContext/* DrawerType.Packets */.jw.Packets);};var icon=/*#__PURE__*/react.createElement(Fingerprint/* default */.Z,null);var title=filtered?"remove filter "+filter:"add filter "+filter;if(filter)return/*#__PURE__*/react.createElement(Tooltip/* default */.Z,{title:filtered?"remove filter "+filter:"add filter "+filter},/*#__PURE__*/react.createElement("span",null,/*#__PURE__*/react.createElement(Chip/* default */.Z,{className:className,size:"small",icon:/*#__PURE__*/react.createElement(IconButton/* default */.Z,{"aria-label":title,onClick:handleFilterClick,size:"small"},icon),label:ids})));else return/*#__PURE__*/react.createElement(Chip/* default */.Z,{"aria-label":title,className:className,size:"small",icon:icon,title:"identifier "+ids,label:ids});}
...
var components_DbContext = __webpack_require__(24973);
...
function useIdleCallback_useIdleCallback(cb,timeout,deps){useEffect(()=>{if(typeof window==="undefined"||!cb)return;if("requestIdleCallback"in window){var id=window.requestIdleCallback(cb,{timeout});return()=>window.cancelIdleCallback(id);}else{var _id=setTimeout(cb,timeout);return()=>clearTimeout(_id);}},[cb,timeout].concat(_toConsumableArray(deps||[])));}
// EXTERNAL MODULE: ./src/components/hooks/useMounted.ts
var hooks_useMounted = __webpack_require__(96173);
// EXTERNAL MODULE: ./src/components/hooks/useAnalytics.tsx + 88 modules
var hooks_useAnalytics = __webpack_require__(92513);
// EXTERNAL MODULE: ./src/components/devices/useDeviceSpecifications.ts
var devices_useDeviceSpecifications = __webpack_require__(56225);
;// CONCATENATED MODULE: ./src/components/firmware/useFirmwareBlobs.ts
function useFirmwareBlobs(){var{bus}=useContext(JacdacContext);var{db}=useContext(DbContext);var{trackEvent}=useAnalytics();var{0:throttled,1:setThrottled}=useState(false);var mounted=useMounted();var firmwares=db===null||db===void 0?void 0:db.firmwares;var specifications=useDeviceSpecifications();var loadFirmwares=useCallback(/*#__PURE__*/_asyncToGenerator(function*(){var names=yield firmwares===null||firmwares===void 0?void 0:firmwares.list();if(!names)return;var slugs=unique(specifications.filter(spec=>{var _spec$productIdentifi;return!!(spec!==null&&spec!==void 0&&(_spec$productIdentifi=spec.productIdentifiers)!==null&&_spec$productIdentifi!==void 0&&_spec$productIdentifi.length);})// needs some product identifiers
...
continue;}}console.debug("firmware: fetch latest release of "+slug);var{status,release}=yield fetchLatestFirmwareRelease(slug,{ignoreThrottled:true});trackEvent("github.fetch",{status,slug});if(status===403){trackEvent("github.fetch.throttled",{repo:slug});if(mounted())setThrottled(true);}if(!(release!==null&&release!==void 0&&release.version)){trackEvent("github.fetch.notfound",{repo:slug});console.warn("firmware: release not found");return;}setThrottled(false);//console.debug(
//    `firmware: fetch binary release ${slug} ${release.version}`
//)
var firmware=yield fetchFirmwareReleaseBinary(slug,release.version);if(firmware){console.debug("firmware: binary release "+slug+" "+release.version+" downloaded");firmwares.set(slug,{time:Date.now(),firmware});}// throttle github queries
...
useChangeAsync(firmwares,/*#__PURE__*/function(){var _ref2=_asyncToGenerator(function*(fw){var names=yield fw===null||fw===void 0?void 0:fw.list();var uf2s=[];if(names!==null&&names!==void 0&&names.length){for(var name of names){var{firmware}=(yield fw.get(name))||{};if(firmware){var uf2Blobs=yield parseFirmwareFile(firmware,name);uf2Blobs===null||uf2Blobs===void 0?void 0:uf2Blobs.forEach(uf2Blob=>{uf2s.push(uf2Blob);});}}}bus.firmwareBlobs=uf2s;});return function(_x){return _ref2.apply(this,arguments);};}(),[]);return{throttled};}function useFirmwareBlob(repoSlug){var _repoSlug;repoSlug=(_repoSlug=repoSlug)===null||_repoSlug===void 0?void 0:_repoSlug.replace(/^https:\/\/github\.com\//i,"");var{db}=(0,react.useContext)(components_DbContext/* default */.ZP);var firmwares=db===null||db===void 0?void 0:db.firmwares;var blobs=(0,useChange/* useChangeAsync */.R)(firmwares,/*#__PURE__*/(0,asyncToGenerator/* default */.Z)(function*(){if(!repoSlug)return undefined;var{firmware}=(yield firmwares===null||firmwares===void 0?void 0:firmwares.get(repoSlug))||{};if(!firmware){return undefined;}else{var uf2Blobs=yield (0,flashing/* parseFirmwareFile */.Ub)(firmware,repoSlug);return uf2Blobs;}}),[repoSlug]);var setFirmwareFile=/*#__PURE__*/function(){var _ref4=(0,asyncToGenerator/* default */.Z)(function*(tag,f){if(!f)yield firmwares===null||firmwares===void 0?void 0:firmwares.set(repoSlug,undefined);else yield firmwares===null||firmwares===void 0?void 0:firmwares.set(repoSlug,{time:Date.now(),firmware:f});});return function setFirmwareFile(_x2,_x3){return _ref4.apply(this,arguments);};}();return{firmwareBlobs:blobs,setFirmwareFile};}
// EXTERNAL MODULE: ./src/components/github/GithubRepositoryCardHeader.tsx + 1 modules
var GithubRepositoryCardHeader = __webpack_require__(6885);
...
;// CONCATENATED MODULE: ./src/components/firmware/FirmwareCard.tsx
function FirmwareCard(props){var{slug}=props;var{response:releases}=(0,github/* useLatestFirmwareReleases */.ET)(slug);var{0:downloading,1:setDownloading}=(0,react.useState)(false);var{0:error,1:setError}=(0,react.useState)("");var{0:release,1:setRelease}=(0,react.useState)(undefined);var{0:firmwaresExpanded,1:setFirmwaresExpanded}=(0,react.useState)(false);var{setFirmwareFile,firmwareBlobs}=useFirmwareBlob(slug);var tag=(release===null||release===void 0?void 0:release.version)||"";var disabled=downloading;var version=firmwareBlobs===null||firmwareBlobs===void 0?void 0:firmwareBlobs[0].version;// version starts with v
...
(0,react.useEffect)(()=>{if(releases!==null&&releases!==void 0&&releases.length&&!release)setRelease(releases[0]);},[releases,release]);var handleReleaseChange=ev=>{var v=ev.target.value;var rel=releases===null||releases===void 0?void 0:releases.find(r=>r.version===v);setRelease(rel);};var handleGitHubReleaseDownload=/*#__PURE__*/function(){var _ref=(0,asyncToGenerator/* default */.Z)(function*(){try{setError("");setDownloading(true);var firmware=yield (0,github/* fetchFirmwareReleaseBinary */.e0)(slug,tag);if(firmware)setFirmwareFile(tag,firmware);}finally{setDownloading(false);}});return function handleGitHubReleaseDownload(){return _ref.apply(this,arguments);};}();var handleClear=/*#__PURE__*/function(){var _ref2=(0,asyncToGenerator/* default */.Z)(function*(){try{setError("");setDownloading(true);setFirmwareFile(tag,undefined);}finally{setDownloading(false);}});return function handleClear(){return _ref2.apply(this,arguments);};}();return/*#__PURE__*/react.createElement(Card/* default */.Z,null,/*#__PURE__*/react.createElement(GithubRepositoryCardHeader/* default */.Z,{slug:slug}),/*#__PURE__*/react.createElement(CardContent/* default */.Z,null,error&&/*#__PURE__*/react.createElement(Alert/* default */.Z,{severity:"error"},error),!(firmwareBlobs!==null&&firmwareBlobs!==void 0&&firmwareBlobs.length)&&/*#__PURE__*/react.createElement(Alert/* default */.Z,{severity:"info"},"No firmware binary found in repository."),!!(firmwareBlobs!==null&&firmwareBlobs!==void 0&&firmwareBlobs.length)&&/*#__PURE__*/react.createElement(Box/* default */.Z,{mb:1},/*#__PURE__*/react.createElement(Accordion/* default */.Z,{expanded:firmwaresExpanded,onChange:()=>setFirmwaresExpanded(!firmwaresExpanded)},/*#__PURE__*/react.createElement(AccordionSummary/* default */.Z,{expandIcon:/*#__PURE__*/react.createElement(ExpandMore/* default */.Z,null)},/*#__PURE__*/react.createElement(Typography/* default */.Z,{variant:"body2"},/*#__PURE__*/react.createElement("code",null,version),/*#__PURE__*/react.createElement("span",null," ","(",firmwareBlobs.length," firmwares)"))),/*#__PURE__*/react.createElement(AccordionDetails/* default */.Z,null,/*#__PURE__*/react.createElement(List/* default */.Z,{dense:true},firmwareBlobs.map(blob=>/*#__PURE__*/react.createElement(ListItem/* default */.ZP,{key:blob.productIdentifier},/*#__PURE__*/react.createElement(ListItemText/* default */.Z,{primary:blob.name,secondary:/*#__PURE__*/react.createElement(gatsby_theme_material_ui/* Link */.rU,{to:"/firmwares/0x"+blob.productIdentifier.toString(16)},"0x"+blob.productIdentifier.toString(16))}))))))),(releases===null||releases===void 0?void 0:releases.length)===0&&/*#__PURE__*/react.createElement(Alert/* default */.Z,{severity:"warning"},"No releases found."),!!(releases!==null&&releases!==void 0&&releases.length)&&/*#__PURE__*/react.createElement(SelectWithLabel/* default */.Z,{fullWidth:true,helperText:"choose a version",value:tag,onChange:handleReleaseChange},releases===null||releases===void 0?void 0:releases.map(rel=>/*#__PURE__*/react.createElement(MenuItem/* default */.Z,{key:rel.version,value:rel.version},rel.version)))),/*#__PURE__*/react.createElement(CardActions/* default */.Z,null,!downloading&&release&&/*#__PURE__*/react.createElement(Button/* default */.Z,{disabled:downloading,color:downloadColor,variant:downloadVariant,"aria-label":"Download last release from "+slug,onClick:handleGitHubReleaseDownload},"Download"),!downloading&&(firmwareBlobs===null||firmwareBlobs===void 0?void 0:firmwareBlobs.length)&&/*#__PURE__*/react.createElement(Button/* default */.Z,{disabled:disabled,variant:"text","arial-label":"Clear",onClick:handleClear},"Clear"),downloading&&/*#__PURE__*/react.createElement(LoadingProgress/* default */.Z,null)));}
...
;// CONCATENATED MODULE: ./src/components/ui/DownloadFirmwareButton.tsx
var _excluded=["url","children"];function DownloadFirmwareButton(props){var{url,children}=props,rest=(0,objectWithoutPropertiesLoose/* default */.Z)(props,_excluded);var{bus}=(0,react.useContext)(Context/* default */.Z);var handleClick=/*#__PURE__*/function(){var _ref=(0,asyncToGenerator/* default */.Z)(function*(){return yield bus.disconnect();});return function handleClick(){return _ref.apply(this,arguments);};}();return/*#__PURE__*/react.createElement(lib/* Button */.zx,Object.assign({},rest,{href:url,onClick:handleClick}),children||"Download");}
...
;// CONCATENATED MODULE: ./src/components/makecode/MakeCodeExtensions.tsx
function MakeCodeExtensions(props){var _arrayify;var{serviceName,serviceClass,header}=props;var serviceNames=(0,utils/* unique */.Tw)([].concat((0,toConsumableArray/* default */.Z)((serviceName===null||serviceName===void 0?void 0:serviceName.split(/\s*,\s*/gi).filter(s=>!!s))||[]),(0,toConsumableArray/* default */.Z)(((_arrayify=(0,utils/* arrayify */.lE)(serviceClass))===null||_arrayify===void 0?void 0:_arrayify.map(sc=>{var _serviceSpecification;return(_serviceSpecification=(0,spec/* serviceSpecificationFromClassIdentifier */.d5)(sc))===null||_serviceSpecification===void 0?void 0:_serviceSpecification.shortId;}).filter(s=>!!s))||[])));var query=(0,gatsby_browser_entry.useStaticQuery)("1871237956");var nodes=(0,react.useMemo)(()=>{var nodes=query.allMdx.edges.map(edge=>edge.node);// filter out
if(serviceNames!==null&&serviceNames!==void 0&&serviceNames.length)nodes=nodes.filter(node=>serviceNames.some(n=>node.fields.slug.indexOf(n)>-1));return nodes;},[serviceNames.join(",")]);return/*#__PURE__*/react.createElement(PageLinkList/* default */.Z,{header:header,nodes:nodes.map(_ref=>{var{fields,frontmatter}=_ref;return{slug:fields.slug,title:frontmatter.title,order:frontmatter.order};})});}
...
//# sourceMappingURL=component---src-templates-device-tsx-49206ad9fbf1fe97965b.js.map