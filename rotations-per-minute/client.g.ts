namespace modules {
    ...
    export class RotationsPerMinuteClient extends jacdac.SimpleSensorClient {
        ...
        constructor(role: string) {
            super(jacdac.SRV_ROTATIONS_PER_MINUTE, role, jacdac.RotationsPerMinuteRegPack.Rpm)

            this._clicksPerTurn = this.addRegister<[number]>(jacdac.RotationsPerMinuteReg.ClicksPerTurn, jacdac.RotationsPerMinuteRegPack.ClicksPerTurn, jacdac.RegisterClientFlags.Const)
            this._minRpm = this.addRegister<[number]>(jacdac.RotationsPerMinuteReg.MinRpm, jacdac.RotationsPerMinuteRegPack.MinRpm, jacdac.RegisterClientFlags.Const)
            this._maxRpm = this.addRegister<[number]>(jacdac.RotationsPerMinuteReg.MaxRpm, jacdac.RotationsPerMinuteRegPack.MaxRpm, jacdac.RegisterClientFlags.Const)            
        }
    ...
    export const rotationsPerMinute1 = new RotationsPerMinuteClient("rotations Per Minute1");
}